...
let HotelController = class HotelController {
    async create({ currentUser: user }, _a) {
        ...
        hotel = await new Hotel().setACL(acl).save(Object.assign(Object.assign({}, rest), { name, coords: new leanengine_1.GeoPoint(coords), creator: user, verified: false }), { user });
        return hotel.toJSON();
    }
    ...
    async edit({ currentUser: user }, id, _a) {
        ...
        await hotel.save(Object.assign(Object.assign({}, rest), { coords: new leanengine_1.GeoPoint(coords), verified: false, verifier: null }), { user });
    ...
    async verify({ currentUser: user }, id, { verified }) {
        ...
        await leanengine_1.Object.createWithoutData('Hotel', id).save({ verified, verifier: user }, { user });
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], HotelController.prototype, "verify", null);
__decorate([
